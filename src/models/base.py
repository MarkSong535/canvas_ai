...
def supports_stop_parameter(model_id: str) -> bool:
    ...
    Args:
        model_id (`str`): Model identifier (e.g. "openai/o3", "o4-mini-2025-04-16", "gpt-5")

    Returns:
        bool: True if the model supports the stop parameter, False otherwise
    """
    model_name = model_id.split("/")[-1]
    # o3, o4-mini, and gpt-5 (including versioned variants, o3-2025-04-16) don't support stop parameter
