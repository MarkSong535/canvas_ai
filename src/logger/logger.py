...
class AgentLogger(logging.Logger, metaclass=Singleton):
    def __init__(self, name="logger", level=logging.DEBUG):
        ...
        # Define a formatter for log messages with UTF-8 support
    ...
    def init_logger(self, log_path: str, level=logging.DEBUG):
        ...
        # 设置Rich控制台，确保支持UTF-8和emoji
        self.console = Console(width=100, force_terminal=True, legacy_windows=False)
